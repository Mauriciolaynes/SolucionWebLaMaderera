...
<body>
    ...
    <div class="main-content">
        <header class="main-header">
            ...
            <a href="${pageContext.request.contextPath}/ventas/nueva" class="btn btn-primary"><i class="fas fa-plus"></i> Registrar Nueva Venta</a>
        </header>
                ...
                <tbody>
                    <c:forEach var="venta" items="${ventas}">
                        <tr>
                            ...
                            <td><c:out value="${venta.usuario.nombresApellidos}"/></td>
                            <td style="text-align: right;">S/ <fmt:formatNumber value="${venta.total}" type="number" minFractionDigits="2" maxFractionDigits="2"/></td>
                            <td>
                                <a href="${pageContext.request.contextPath}/ventas/ver/${venta.id}" class="btn-action view"><i class="fas fa-eye"></i> Ver</a>
                            </td>
                        </tr>
                    </c:forEach>
                </tbody>
