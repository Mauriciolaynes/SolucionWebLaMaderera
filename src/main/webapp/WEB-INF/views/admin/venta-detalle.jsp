            ...
            <body>
                ...
                <div class="main-content">
                    <header class="main-header">
                        ...
                        <div>
                            <a href="${pageContext.request.contextPath}/guias/salida/${venta.id}" target="_blank"
                                class="btn btn-primary" style="margin-right: 10px;">
                                <i class="fas fa-file-alt"></i> Imprimir Guía de Salida
                            </a>
                            <a href="${pageContext.request.contextPath}/ventas/listar" class="btn">
