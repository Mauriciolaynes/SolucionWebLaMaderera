                    ...
                    <tbody>
                        <c:forEach var="detalle" items="${pedido.detalles}">
                            <tr>
                                ...
                                <td class="text-end">
                                    <fmt:formatNumber value="${detalle.precioCompra}" type="currency" currencySymbol="S/ " />
                                </td>
                                <td class="text-end">
                                    <fmt:formatNumber value="${detalle.cantidad * detalle.precioCompra}" type="currency" currencySymbol="S/ " />
                                </td>
                            </tr>
                        </c:forEach>
                    </tbody>
                    <tfoot>
                        <tr class="fw-bold">
                            ...
                            <td class="text-end fs-5">
                                <fmt:formatNumber value="${pedido.total}" type="currency" currencySymbol="S/ " />
                            </td>
                        </tr>
                    </tfoot>
                </table>
