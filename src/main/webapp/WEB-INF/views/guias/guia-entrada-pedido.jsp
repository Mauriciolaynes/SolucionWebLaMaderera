        ...
        <%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt" %>
            ...
            <body>
                ...
                <div class="no-print">
                    ...
                    <a href="${pageContext.request.contextPath}/compras" class="btn-volver">
                        ← Volver
                    </a>
                </div>
                ...
                <div class="guia-container">
                    ...
                    <div class="header">
                        ...
                        <div class="tipo-doc">${tipoDocumento} - ${pedido.numeroPedido}</div>
                    </div>

                    <!-- Información de la guía y proveedor -->
                    <div class="info-grid">
                        ...
                        <div class="info-section">
                            ...
                            <p><strong>RUC:</strong>
                                <c:out value="${pedido.proveedor.ruc}" />
                            </p>
                            <p><strong>Teléfono:</strong>
                                <c:out value="${pedido.proveedor.telefono}" />
                            </p>
                            <p><strong>Dirección:</strong>
                                <c:out value="${pedido.proveedor.direccion}" />
                            </p>
                        </div>
                    </div>
                            ...
                            <c:forEach var="detalle" items="${pedido.detalles}">
                                <tr>
                                    ...
                                    <td class="text-right">S/
                                        <fmt:formatNumber value="${detalle.precioCompra}" type="number"
                                            minFractionDigits="2" maxFractionDigits="2" />
                                    </td>
                                    <td class="text-right">S/
                                        <fmt:formatNumber value="${detalle.precioCompra * detalle.cantidad}"
                    ...
                    <div class="total-section">
                        <div class="total">
                            Total: S/
                            <fmt:formatNumber value="${pedido.total}" type="number" minFractionDigits="2"
                                maxFractionDigits="2" />
                        </div>
                    </div>
