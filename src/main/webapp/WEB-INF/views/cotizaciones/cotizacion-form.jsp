            ...
            <body>
                ...
                <div class="container mt-5 mb-5">
                    ...
                    <%-- MENSAJES DE ALERTA (Success, Error, Warning) --%>
                        ...
                        <form id="formCotizacion" action="<c:url value='/cotizaciones/guardar'/>" method="post"
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <%-- Columna Proveedor --%>
                                                <div class="col-md-4">
                                                    ...
                                                    <select name="proveedor.idProveedor" id="selectProveedor"
                                                        class="form-select" required>
                                                        <option value="">-- Seleccione proveedor --</option>

                                                        <c:forEach var="p" items="${proveedores}">
                                                            <option value="${p.idProveedor}" <c:if
                                                                test="${cotizacion.proveedor != null && cotizacion.proveedor.idProveedor == p.idProveedor}">
                                                                selected</c:if>>
                                                    ...
                                                    <c:if
                                                        test="${result != null && result.hasFieldErrors('proveedor.idProveedor')}">
                                                        <span
                                                            class="text-danger">${result.getFieldError('proveedor.idProveedor').defaultMessage}</span>
                                                    </c:if>
                                                ...
                                                <%-- Columna Pedido Asociado (OBLIGATORIO) --%>
                                                    <div class="col-md-4">
                                                        ...
                                                        <%-- NOTA: Eliminamos la iteración JSTL, será llenado por AJAX
                                                            --%>
                                                            <select name="pedido.idPedidoCompra" id="selectPedido"
                                                                class="form-select" required>
                                                                <option value="">-- Seleccione proveedor primero --
                                                                </option>
                                                            </select>
                                                            ...
                                                            <%-- Mostrar error de validación del Pedido --%>
                                                                <c:if
                                                                    test="${result != null && result.hasFieldErrors('pedido')}">

                                                                    <span
                                                                        class="text-danger">${result.getFieldError('pedido').defaultMessage}</span>
                                                                </c:if>
                                                    </div>
                                                    ...
                                                    <%-- Columna Fecha --%>
                                                        <div class="col-md-4">
                                                            ...
                                                            <input type="date" name="fecha" class="form-control"
                                                                value="${cotizacion.fecha}" required />
                                                        </div>
                                        </div>
                                                    ...
                                                    <div class="col-md-5 mb-3">
                                                        ...
                                                        <c:if test="${not empty cotizacion.archivoAdjunto}">
                                                            ...
                                                            <small class="form-text text-muted">Archivo actual: <a
                                                                    href="<c:url value='/uploads/cotizaciones/${cotizacion.archivoAdjunto}'/>"
                                                                    target="_blank">${cotizacion.archivoAdjunto}</a></small>
                                                        </c:if>
                                                    </div>
                                                    ...
                                                    <%-- Columna Estado --%>
                                                        <div class="col-md-3 mb-3">
                                                            ...
                                                            <select name="estado" class="form-select">
                                                                <c:forEach var="estado" items="${estados}">
                                                                    ...
                                                                    <option value="${estado}"
                                                                        ${estado==cotizacion.estado ? 'selected' : '' }>
                                                                        ${estado}
                                                                    </option>
                                                                </c:forEach>
                                                        ...
                                                        <%-- Columna Condiciones --%>
                                                            <div class="col-md-4 mb-3">
                                                                ...
                                                                <label class="form-label">Condiciones
                                                                    (opcional):</label>
                                                                <input type="text" name="condiciones"
                                                                    class="form-control"
                                                                    value="${cotizacion.condiciones}"
                                                                    placeholder="Plazos, garantías, observaciones" />
                                                            </div>
                                            </div>
                                </div>
                                ...
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body p-0">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-hover table-sm table-detalle mb-0"
                                                id="tabla-detalles">
                                                ...
                                                <tbody>
                                                    <%-- **CORRECCIÓN CRÍTICA:** Se elimina la carga de filas de
                                                        detalles por JSTL (${cotizacion.detalles}) para evitar que se
                                                        rendericen selectores vacíos si la lista de productos es
                                                        incompleta. Toda la carga de detalles se delega ahora a la
                                                        función AJAX/JS: loadDetallesPedido(). --%>
                                                </tbody>
                                                <tfoot>
                                                    <tr>
                                                        ...
                                                        <td colspan="2"><strong id="total-cotizacion">S/ 0.00</strong>
                                                        </td>
                                                    </tr>
                                                </tfoot>
                                            </table>
                                ...
                                <%-- Botones de Acción --%>
                                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                        ...
                                        <button type="button" class="btn btn-success"
                                            onclick="enviarCotizacionSegura()">Guardar Cotización</button>
                                    </div>
                ...
                <script>
                    document.addEventListener('DOMContentLoaded', function () {
                        ...
                        window.loadPedidos = function (idProveedor) {
                            ...
                            if (!idProveedor) {
                                selectPedido.innerHTML = '<option value="">-- Seleccione proveedor primero --</option>';
                            ...
                            fetch(contextPath + '/api/v1/pedidos/proveedor/' + idProveedor)
                                ...
                                .then(data => {
                                    if (!data || data.length === 0) {
                                        selectPedido.innerHTML = '<option value="">No hay pedidos para este proveedor</option>';
                                        selectPedido.disabled = true;
                                        alert('No hay pedidos de compra registrados para el proveedor seleccionado.\\n\\nPor favor, cree primero un pedido de compra antes de registrar una cotización.');
                                        return;
                                    }
                                ...
                                .catch(e => {
                                    ...
                                    selectPedido.innerHTML = '<option value="">⚠️ Error al cargar pedidos</option>';
                                    selectPedido.disabled = true;
                                    alert('Ocurrió un error al cargar los pedidos.\\n\\nVerifique que existan pedidos de compra registrados.');
                                });
                        };
