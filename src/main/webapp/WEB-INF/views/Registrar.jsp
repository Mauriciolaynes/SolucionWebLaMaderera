...
<head>
    ...
    <%-- Se importa el CSS de la página principal para reutilizar la cabecera --%>
...
<body>
    ...
    <div class="col">
        ...
        <button type="button" class="btn-secundario" onclick="window.location.href='${homeUrl}'">Atras</button>
    </form>
</body>
</html>
