        ...
        <form:form method="post" modelAttribute="proveedor" action="${pageContext.request.contextPath}/proveedores/guardar">
            ...
            <div class="form-grid-2">
                ...
                <div>
                    ...
                    <form:input path="ruc" id="ruc" required="true"/>
                    <form:errors path="ruc" cssClass="text-danger"/>
                    
                </div>
                <div>
                    <label for="telefono">Teléfono:</label>
                    <form:input path="telefono" id="telefono" required="true"/>
                ...
                <div>
                    ...
                    <form:input path="correo" id="correo" required="true"/>
                    <form:errors path="correo" cssClass="text-danger"/>
                    
                </div>
                <div>
                    <label for="direccion">Dirección:</label>
                    <form:input path="direccion" id="direccion" required="true"/>
                ...
                <a href="${pageContext.request.contextPath}/proveedores/listar" class="btn-cancelar">
                    <i class="fas fa-times-circle"></i> Retornar
                </a>
                <button type="submit">
